  ...
  const fetchNewsData = useCallback(
    async (country: string = "") => {
      ...
      try {
        ...
        const briefing = await newsService.getLatestNews(
          language,
          country,
          "technology",
        );
        ...
        let trending = await newsService.getLatestNews(
          language,
          country,
          "lifestyle",
        );
        if (trending.length === 0 && country) {
          console.log(
            "Lifestyle trending empty, falling back to general for country",
          );
                ...
                >
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-[10px] text-slate-500 mt-1">
                      {timeAgo(breakingNews[0].published)}
                    </Text>
                  </View>
                </TouchableOpacity>
              ) : (
        ...
        {isLoading ? (
          ...
          <>
                  ...
                  >
                    ...
                    <View className="p-5">
                      <View className="flex-row items-center mb-2">
                        <Text
                          className="text-blue-600 font-semibold text-xs uppercase tracking-wider"
                          numberOfLines={1}
                        >
                          {news.author || "News"}
                        </Text>
              ...
              >
                {dailyBriefing.map((news) => (
                  ...
                  >
                    ...
                    <View className="mt-3">
                      <Text
                        className="text-blue-600 font-semibold text-xs uppercase tracking-wider mb-1"
                        numberOfLines={1}
                      >
                        {news.author || "Daily"}
                      </Text>
            ...
            <View className="px-6 pt-2 pb-12">
              <Text className="text-xl font-extrabold text-slate-900 dark:text-white mb-4">
                {t("trending_now")}
              </Text>
